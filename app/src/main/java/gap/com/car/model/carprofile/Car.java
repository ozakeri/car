...
public class Car implements Parcelable
{
    ...
    @SerializedName("carProfitLegal")
    @Expose
    public CarProfitLegal carProfitLegal;
    ...
    @SerializedName("carProfitOwner")
    @Expose
    public CarProfitOwner carProfitOwner;
    ...
    @SerializedName("carOptionTechnicalCheckFP")
    @Expose
    public CarOptionTechnicalCheckFP carOptionTechnicalCheckFP;
    ...
    @SerializedName("carOptionInsuranceFP")
    @Expose
    public CarOptionInsuranceFP carOptionInsuranceFP;
    ...
    protected Car(Parcel in) {
        ...
        this.carUsage = ((CarUsage) in.readValue((CarUsage.class.getClassLoader())));
        ...
        this.carProfitLegal = ((CarProfitLegal) in.readValue((CarProfitLegal.class.getClassLoader())));
        ...
        this.pictureAF = ((PictureAF) in.readValue((PictureAF.class.getClassLoader())));
        this.vehicle = ((Vehicle_) in.readValue((Vehicle_.class.getClassLoader())));
        ...
        this.company = ((Company_) in.readValue((Company_.class.getClassLoader())));
        this.deliveryDate = ((String) in.readValue((String.class.getClassLoader())));
        this.carProfitOwner = ((CarProfitOwner) in.readValue((CarProfitOwner.class.getClassLoader())));
        ...
        this.carOptionTechnicalCheckFP = ((CarOptionTechnicalCheckFP) in.readValue((CarOptionTechnicalCheckFP.class.getClassLoader())));
        ...
        this.carOptionInsuranceFP = ((CarOptionInsuranceFP) in.readValue((CarOptionInsuranceFP.class.getClassLoader())));
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(carProfitLegal);
