...
public class CarOptionTechnicalCheckFP implements Parcelable
{
    ...
    public final static Creator<CarOptionTechnicalCheckFP> CREATOR = new Creator<CarOptionTechnicalCheckFP>() {


        @SuppressWarnings({
            "unchecked"
        })
        public CarOptionTechnicalCheckFP createFromParcel(Parcel in) {
            return new CarOptionTechnicalCheckFP(in);
        }

        public CarOptionTechnicalCheckFP[] newArray(int size) {
            return (new CarOptionTechnicalCheckFP[size]);
        }

    }
    ;

    protected CarOptionTechnicalCheckFP(Parcel in) {
    ...
    public CarOptionTechnicalCheckFP() {
    }
