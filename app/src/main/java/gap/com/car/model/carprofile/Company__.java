...
public class Company__ implements Parcelable
{
    ...
    public final static Creator<Company__> CREATOR = new Creator<Company__>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Company__ createFromParcel(Parcel in) {
            return new Company__(in);
        }

        public Company__[] newArray(int size) {
            return (new Company__[size]);
        }

    }
    ;

    protected Company__(Parcel in) {
