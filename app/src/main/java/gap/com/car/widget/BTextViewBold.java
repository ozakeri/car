 ...
 */
public class BTextViewBold extends androidx.appcompat.widget.AppCompatTextView {
    private String rawText;

    public BTextViewBold(Context context) {
        super(context);
        init();
    }

    public BTextViewBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BTextViewBold(Context context, AttributeSet attrs, int defStyleAttr) {
